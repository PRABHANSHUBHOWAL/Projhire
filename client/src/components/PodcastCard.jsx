...
const PlayIcon = styled.div`
  ...
  color: ${({ theme }) => theme.secondary} !important; /////tobe changed
  ...
  // box-shadow: 0 0 16px 4px #2e85ff !important;
`;
...
const Favorite = styled(IconButton)`
  ...
  position: absolute !important;
  backdrop-filter: blur(4px);
  // box-shadow: 0 0 5px 5px #222423 !important;
`
          ...
          <MainInfo>
            ...
            <CreatorInfo>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Avatar
                  src={podcast.creator.img} style={{ width: '26px', height: '26px' }}>{podcast.creator.name?.charAt(0).toUpperCase()}
                </Avatar>
                <CreatorName>
